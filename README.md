[![Build Status](https://travis-ci.org/codedoctor/hapi-oauth-store-multi-tenant.svg?branch=master)](https://travis-ci.org/codedoctor/hapi-oauth-store-multi-tenant)
